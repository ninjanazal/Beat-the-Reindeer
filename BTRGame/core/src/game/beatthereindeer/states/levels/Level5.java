...
public class Level5 extends State {
    ...
    private Vector2 lastPosition2, lastPosition3;
    ...
    public Level5(GameStateManager gsm) {
        ...
        //MAP
        mapSprite = new Sprite(new Texture(Gdx.files.internal("lvl5/lvl5Map.png")));
    ...
    public void update(Float dt) {
        ...
        if (isPlaying && (player.getHp() != 0 || boss.getHp() != 0)) {
            ...
            if (!boss.isShoot()) {
                ...
                lastPosition2 = new Vector2(player.getPosition().x - boss.getCenter().x, player.getPosition().y - boss.getCenter().y).rotate(35);
                lastPosition3 = new Vector2(player.getPosition().x - boss.getCenter().x, player.getPosition().y - boss.getCenter().y).rotate(-35
                );
