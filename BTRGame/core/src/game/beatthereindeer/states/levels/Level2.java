...
import game.beatthereindeer.Boss1;
...
public class Level2 extends State {
    ...
    public Level2(GameStateManager gsm) {
        ...
        //MAP
        mapSprite = new Sprite(new Texture(Gdx.files.internal("lvl2/lvl2Map.png")));
        ...
        bossBulletTexture = new Texture(Gdx.files.internal("lvl2/bullet2.png"));
